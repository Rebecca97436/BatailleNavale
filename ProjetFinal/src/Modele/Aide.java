...
class Aide {
     public void Aide() 
    {
     System.out.println ( "Règles : Au début du jeu, chaque joueur place à sa guise tous les bateaux sur sa grille de façon stratégique.\n "
                                 ...
                                 +"Chaque joueur possède un cuirassé (7 cases) avec une puissance de tir de 9 cases, un croiseur (5 cases) avec une puissance de tir de 4 cases,\n "
             + "                   un destroyeur (3 cases) avec une puissance de tir d'une case et un sous marin (1 case) avec une puissance de tir d'une case.\n"
                                  );
        new Menu();
    }
}
